      ...
      <div className="page-wrapper">
        <div className="page-body">
          <div className="container-xl">
            <div className="row">
              <div className="col-2 p-0 border pe-2 border-start-0 border-top-0 border-bottom-0  border-black ">
                <div className="d-flex flex-column ">
                  ...
                  >
                    <p
                      className={`p-2 d-flex align-items-center cursor-pointer text-${
                        Section === "Information" ? "dark" : "secondary"
                      } `}
                    >
                  ...
                  >
                    <p
                      className={`p-2 d-flex align-items-center cursor-pointer  text-${
                        Section === "Association" ? "dark" : "secondary"
                      }`}
                    >
                  ...
                  >
                    <p
                      className={`p-2 d-flex align-items-center cursor-pointer  text-${
                        Section === "Shipping" ? "dark" : "secondary"
                      } `}
                    >
                  ...
                  >
                    <p
                      className={`p-2 d-flex align-items-center cursor-pointer  text-${
                        Section === "Attachment" ? "dark" : "secondary"
                      } `}
                    >
                                  ...
                                  {values?.price?.map((combination, index) => {
                                    return (
                                      <tr key={index}>
                                        ...
                                        <td>
                                          {values.price[index]?.tax || 0.0}
                                        </td>
                                        <td>
                                          {values.price[index]?.company_cost ||
                                            0.0}
                                        </td>
                                        <td>
