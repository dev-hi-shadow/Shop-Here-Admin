    ...
    return (
        <>
            <main className="main-content my-3 ps">
                                ...
                                <div className="card z-index-0">
                                    ...
                                    <div className="card-body">
                                        <form role="form text-left" onSubmit={handleSubmit}>
                                            <div className="mb-3">
                                                <input onChange={handleChange} onBlur={handleBlur} value={values?.name} name="name" type="text" className={`form-control ${(touched.name && errors.name) && "is-invalid"}`} placeholder="Name" aria-label="Name" aria-describedby="email-addon" />
                                                {(touched.name && errors.name) && <p className="h6 text-danger mt-1"> {errors.name} </p>}

                                            </div>
                                            <div className="mb-3">
                                                <input onChange={handleChange} onBlur={handleBlur} value={values?.email} name="email" type="email" className={`form-control ${(touched.email && errors.email) && "is-invalid"}`} placeholder="Email" aria-label="Email" aria-describedby="email-addon" />
                                                {(touched.email && errors.email) && <p className="h6 text-danger mt-1"> {errors.email} </p>}

                                            </div>
                                            <div className="mb-3">
                                                <input onChange={handleChange} onBlur={handleBlur} value={values?.phone} name="phone" type="number" className={`form-control ${(touched.phone && errors.phone) && "is-invalid"}`} placeholder="Phone Number" aria-label="phone" aria-describedby="phone-addon" />
                                                {(touched.phone && errors.phone) && <p className="h6 text-danger mt-1"> {errors.phone} </p>}

                                            </div>
                                            <div className="mb-3">
                                                <input onChange={handleChange} onBlur={handleBlur} value={values?.password} name="password" type="password" className={`form-control ${(touched.password && errors.password) && "is-invalid"}`} placeholder="Password" aria-label="Password" aria-describedby="password-addon" />
                                                {(touched.password && errors.password) && <p className="h6 text-danger mt-1"> {errors.password} </p>}

                                            </div>
                                            <div className="mb-3">
                                                <input onChange={handleChange} onBlur={handleBlur} value={values?.confirmPassword} name="confirmPassword" type="password" className={`form-control ${(touched.confirmPassword && errors.confirmPassword) && "is-invalid"}`} placeholder="Confirm Password" aria-label="Password" aria-describedby="password-addon" />
                                                {(touched.confirmPassword && errors.confirmPassword) && <p className="h6 text-danger mt-1"> {errors.confirmPassword} </p>}
                                            ...
                                            <p className="text-sm mt-3 mb-0">Already have an account? <Link to="/sign-in" className="text-dark font-weight-bolder">Sign in</Link></p>
                                        </form>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="ps__rail-x" style={{ left: "0px", bottom: "0px" }}><div className="ps__thumb-x" tabIndex="0" style={{ left: "0px", width: "0px" }}></div></div><div className="ps__rail-y" style={{ top: "0px", right: "0px" }}><div className="ps__thumb-y" tabIndex="0" style={{ top: "0px", height: '0px' }}></div></div></main>
        </>
    )
}
