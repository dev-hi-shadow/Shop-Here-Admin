                    ...
                    <div className="container-xl">
                        <div className="row row-deck row-cards">
                                        ...
                                        <div className="d-flex mb-2">
                                            ...
                                            <div className="ms-auto">
                                                <span className="text-green d-inline-flex align-items-center lh-1">
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="icon ms-1" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M3 17l6 -6l4 4l8 -8" /><path d="M14 7l7 0l0 7" /></svg>
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="d-flex align-items-baseline">
                                            ...
                                            <div className="me-auto">
                                                <span className="text-yellow d-inline-flex align-items-center lh-1">
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="icon ms-1" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M5 12l14 0" /></svg>
                                                </span>
                                            </div>
                                        </div>
                                            ...
                                            <div className="card-body">
                                                <div className="row align-items-center">
                                                    <div className="col-auto">
                                                        <span className="bg-primary text-white avatar">{/* Download SVG icon from http://tabler-icons.io/i/currency-dollar */}
                                                ...
                                                <div className="divide-y">
                                                        ...
                                                        <div className="row">
                                                            ...
                                                            <div className="col">
                                                                <div className="text-truncate">
                                                                    <strong>Jeffie Lewzey</strong> commented on your <strong>Im not a witch</strong> post.
                                                                </div>
                                                    ...
                                                    <div>
                                                        <div className="row">
                                                            ...
                                                            <div className="col">
                                                                <div className="text-truncate">
                                                                    Its <strong>Mallory Hulme</strong>s birthday. Wish him wells
                                                                </div>
                                                    ...
                                                    <div>
                                                        <div className="row">
                                                            <div className="col-auto">
                                                                <span className="avatar" style={{ backgroundImage: "url(./static/avatars/000f.jpg)" }} ></span>
                                                            </div>
                                                            <div className="col">
                                                                <div className="text-truncate">
                                                    ...
                                                    <div>
                                                        <div className="row">
                                                            <div className="col-auto">
                                                                <span className="avatar" style={{ backgroundImage: "url(./static/avatars/001f.jpg)" }}></span>
                                                            </div>
                                                            <div className="col">
                                                                <div className="text-truncate">
                                                    ...
                                                    <div>
                                                        <div className="row">
                                                            <div className="col-auto">
                                                                <span className="avatar" style={{ backgroundImage: "url(./static/avatars/002f.jpg)" }}></span>
                                                            </div>
                                                            <div className="col">
                                                                <div className="text-truncate">
                                                    ...
                                                    <div>
                                                        <div className="row">
                                                            <div className="col-auto">
                                                                <span className="avatar" style={{ backgroundImage: "url(./static/avatars/005f.jpg)" }} ></span>
                                                            </div>
                                                            <div className="col">
                                                                <div className="text-truncate">
                                                    ...
                                                    <div>
                                                        <div className="row">
                                                            <div className="col-auto">
                                                                <span className="avatar" style={{ backgroundImage: "url(./static/avatars/006f.jpg)" }} ></span>
                                                            </div>
                                                            <div className="col">
                                                                <div className="text-truncate">
                                        ...
                                        <div className="position-absolute top-0 left-0 px-3 mt-1 w-75">
                                            <div className="row g-2">
                                                ...
                                                <div className="col">
                                                    ...
                                                    <div className="text-muted">{/* Download SVG icon from http://tabler-icons.io/i/trending-up */}
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-inline text-green" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M3 17l6 -6l4 4l8 -8" /><path d="M14 7l7 0l0 7" /></svg>
                                        ...
                                        <div className="row align-items-center">
                                            <div className="col-10">
                                                ...
                                                <div className="markdown text-muted">
                                                    ...
                                                    <Link to="https://tabler-icons.io" target="_blank" rel="noopener noreferrer">tabler-icons.io</Link>,
                                                    download any of the 4158 icons in SVG, PNG or&nbsp;React and use them in your favourite design tools.
                                                </div>
                                                <div className="mt-3">
                                                    <Link to="https://tabler-icons.io" className="btn btn-primary" target="_blank" rel="noopener noreferrer">Download icons</Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="card-table table-responsive">
                                        <table className="table table-vcenter">
                                            ...
                                            <tr>
                                                <td>
                                                    /
                                                    <Link to="#" className="ms-1" aria-label="Open website">{/* Download SVG icon from http://tabler-icons.io/i/link */}
                            ...
                            <div className="col-md-6 col-lg-4">
                                <Link to="https://github.com/sponsors/codecalm" className="card card-sponsor" target="_blank" rel="noopener noreferrer" style={{ backgroundImage: "url(./static/sponsor-banner-homepage.svg)" }} aria-label="Sponsor Tabler!">
                                            ...
                                            <tr>
                                                ...
                                                <td className="text-nowrap">
                                                    <Link to="#" className="text-muted">
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="icon" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M5 12l5 5l10 -10" /></svg>
                                                        2/7
                                                    </Link>
                                                </td>
                                                <td className="text-nowrap">
                                        ...
                                        <div className="d-flex">
                                            <div className="text-muted">
                                                ...
                                                <div className="mx-2 d-inline-block">
                                                    <input type="text" className="form-control form-control-sm"  size="3" aria-label="Invoices count" />
                                                </div>
                                                entries
                                            </div>
