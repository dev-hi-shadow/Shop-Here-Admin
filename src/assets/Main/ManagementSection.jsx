            ...
            <div className="page-wrapper">
                ...
                <div className="page-header d-print-none">
                    <div className="container-xl">
                        <div className="row g-2 align-items-center border-blue border p-1  m-0  " style={{ borderRadius: "5px" }}>
                            <div className="col m-0">
                                ...
                                <div className="d-flex align-items-center">
                                    ...
                                    <h2 className="page-title me-3">
                                        {Capitalize(Module) === "" ? "Dashboard" : Capitalize(Module)}
                                    </h2>
                                    {SubBar[Key]?.length > 0 &&
                                        SubBar[Key]?.map((value, index) => {
                                            return <Link to={"/" + value} key={index} className={` m-0 mx-2 text-sm text-black fw-bold ${value === Module ? "d-none" : ""} `}>{Capitalize(value)}</Link>
